...
const ALL_TOOLS = [
  ...
  },
  {
    ...
    title: 'MRD Producer · One-Pager',
    description: 'Create concise product one-pagers for stakeholder communication and AI-powered PRD generation.',
    href: '/one-pager',
  },
  {
    feature: 'brief-helper' as const,
    title: 'MRD Producer · Brief Helper',
  ...
  },
  {
    ...
    title: 'MRD Producer · One-Pager (Beta)',
  ...
  },
  {
    ...
    title: 'MRD Producer · M3 Preview',
    description: 'One-Pager with M3 design refresh — numbered section headers, card-based layout, and Material-3 controls.',
